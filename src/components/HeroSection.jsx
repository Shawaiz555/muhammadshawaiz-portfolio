...
const HeroSection = () => {
  ...
  return (
    <section id="hero" className="min-h-screen flex items-center relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0 bg-gradient-to-br from-white via-indigo-50 to-purple-50 z-0" />
      <div className="absolute inset-0 opacity-20 bg-dots-pattern z-0" />
      
      <div className="container mx-auto px-4 z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
          <div className="lg:w-1/2 animate-fade-in-up">
            <h4 className="text-purple-600 font-semibold mb-2">Hello, I'm</h4>
            ...
            <p className="text-navy-700 text-lg mt-6 mb-8 max-w-xl">
          ...
          <div className="lg:w-1/2 animate-fade-in">
            <div className="relative">
              <div className="absolute -inset-4 bg-gradient-to-tr from-purple-500 to-indigo-500 rounded-full blur-3xl opacity-20 animate-pulse-slow"></div>
              <div className="bg-white p-2 rounded-2xl shadow-xl relative z-10">
                <img
              ...
              <div className="absolute -bottom-6 -left-6 bg-white p-3 rounded-xl shadow-lg animate-bounce-light">
                <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg" width={40} height={40} alt="React" />
              </div>
              <div className="absolute -top-6 -right-6 bg-white p-3 rounded-xl shadow-lg animate-bounce-light" style={{ animationDelay: "0.5s" }}>
                <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nodejs/nodejs-original.svg" width={40} height={40} alt="Node.js" />
              </div>
              <div className="absolute top-1/2 -right-6 bg-white p-3 rounded-xl shadow-lg animate-bounce-light" style={{ animationDelay: "1s" }}>
